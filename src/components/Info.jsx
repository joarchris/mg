  ...
  return (
    <div className="container">
      <article>
        ...
        <p>
          Then it's time to start all over again, building on top of this period. If you feel fatiqued you would benefit with
          2-3 weeks of deload/base training period before starting strength training again.
        </p>
      </article>
    </div>
  );
